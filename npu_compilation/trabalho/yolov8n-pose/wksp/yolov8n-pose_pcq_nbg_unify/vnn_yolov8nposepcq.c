...
vsi_nn_graph_t * vnn_CreateYolov8nPosePcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 1.569501519203186;
...
error:
    ...
    vnn_ReleaseYolov8nPosePcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolov8nPosePcq() */

void vnn_ReleaseYolov8nPosePcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
