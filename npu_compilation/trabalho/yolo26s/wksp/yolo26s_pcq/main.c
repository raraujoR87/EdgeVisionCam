...
{
    vnn_ReleaseYolo26sPcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26sPcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26sPcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26sPcq( data_file_name, NULL,
