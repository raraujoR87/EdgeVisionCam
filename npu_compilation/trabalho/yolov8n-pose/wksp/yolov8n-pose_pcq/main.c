...
{
    vnn_ReleaseYolov8nPosePcq( graph, TRUE );
...
{
    return vnn_PostProcessYolov8nPosePcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolov8nPosePcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov8nPosePcq( data_file_name, NULL,
